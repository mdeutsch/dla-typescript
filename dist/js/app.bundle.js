...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "0781544af072ce66526d";
...
const launchParticle = (builder, context) => {
    ...
    if (!builder.atMaxSize()) {
        window.requestAnimationFrame(() => { launchParticle(builder, context); });
    }
};
const start = () => {
...
Object.defineProperty(exports, "__esModule", { value: true });
const DLALattice_1 = __webpack_require__(/*! ./DLALattice */ "./src/app/lib/DLALattice.ts");
...
class DLABuilder {
    ...
    launchParticle() {
        let position = this.randomStartingPoint(this.lattice.maxRadius + 10);
        let next;
...
/***/ 0:
/*!**************************************************************!*\
  !*** multi ./src/app/index.ts webpack-hot-middleware/client ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./src/app/index.ts */"./src/app/index.ts");
